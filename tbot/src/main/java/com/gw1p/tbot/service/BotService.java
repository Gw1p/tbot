...
import com.gw1p.tbot.conversation.commands.ListCommandsCommand;
import com.gw1p.tbot.conversation.commands.StatusCommand;
import com.gw1p.tbot.conversation.commands.StopBotCommand;
import com.gw1p.tbot.model.*;
...
public class BotService {
    ...
    @PostConstruct
    public void init() {
        LOGGER = loggerService.getLogger(BotService.class.getName());
